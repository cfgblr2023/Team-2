...
const nextDay = document.getElementById('nextWeek');
const prevDay = document.getElementById('prevWeek');
...
let setData = (day) =>{
    ...
    let daylist = ["Week1", "Week2", "Week3", "Week4", "Week5", "Week6", "Week7"]
    document.querySelector('.timetable div h2').innerHTML = daylist[day];
    switch(day){
        case(0): day = Week1; break;
        case(1): day = Week2; break;
        case(2): day = Week1; break;
